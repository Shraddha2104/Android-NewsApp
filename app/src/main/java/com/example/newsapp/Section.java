...
public class Section extends Fragment implements CardAdaptor.OnItemClickListener, CardAdaptor.OnItemLongClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(Section.this.getContext()));
    ...
    private void section_headlines() {
        ...
        String url = "https://androidbackend-276418.wl.r.appspot.com/gsectab?section="+section_name;
//        String url="https://h9-backend.wl.r.appspot.com/tab?whichtab="+section_name.toLowerCase();
...
//                            JSONObject response = data.getJSONObject("response");
                            ...
                            if(mCardAdaptor==null)
                            {
                                ...
                                mCardAdaptor.setOnItemClickListener(Section.this);
                                mCardAdaptor.setOnItemLongClickListener(Section.this);
                            }
                          else{
